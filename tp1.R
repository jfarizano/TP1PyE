...
tablasAltura <- function(Altura, fuente) {
  ...
  plot(c(frecRelAcum, 1), type = "l", main = tit, sub = fuente, xlab = "Altura (en metros)", ylab = "Frecuencia relativa acumulada", xaxt = "n", font.lab = 2, xlim = c(1, 8))
...
tablasDiametro <- function(Diametro, fuente){
  ...
  plot(c(frecRelAcum, 1), type = "l", main = tit, sub = fuente, xlab = "Diámetro (en cm)", ylab = "Frecuencia relativa acumulada", xaxt = "n", font.lab = 2)
...
tablasInclinacion <- function(Inclinacion, fuente) {
  ...
  # Polígono acumulativo.
  plot(c(frecRelAcum, 1), type = "l", main = tit, sub = fuente, xlim = c(1,6), ylim = c(0.85, 1), xlab = "Inclinación (en grados)", ylab = "Frecuencia relativa acumulada", xaxt = "n", font.lab = 2)
...
tablasEspecie <- function(Especie, fuente) {
   ...
   barplot(frecAbs, ylim = c(0, 70), col = "green", main = tit, sub = fuente, xlab = "Especie", ylab = "Frecuencia absoluta", font.lab = 2)
}
