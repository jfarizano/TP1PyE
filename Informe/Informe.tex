...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{| c | r | r |}
      \hline
      \textbf{Especie} & \textbf{Frecuencia absoluta} & \textbf{Porcentaje} \\ \hline
      Exótico	& 241	& 68.86\% \\ \hline
      Nativo/Autóctono & 109 & 31.14\% \\ \hline
    \end{tabular}
    \caption{Tabla de frecuencias.}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=0.9\linewidth]{tortaOrigen.pdf}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=0.9\linewidth]{bastonesBrotes.pdf}
